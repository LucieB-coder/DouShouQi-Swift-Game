...
class VSRulesUnitTests: XCTestCase {  
    ...
    func testCreateBoard() {
        ...
        let vsRulesBoard : Board = VerySimpleRules.createBoard()
    ...
    func testCheckBoardThrowsBadDimensionsGridEmpty() {
        ...
        XCTAssertThrowsError(try VerySimpleRules.checkBoard(b: self.board)) { error in
    ...
    func testCheckBoardValid() {
        XCTAssertNoThrow(try VerySimpleRules.checkBoard(b: self.board))
    }
    
    func testGetNextPlayerPlayer1ToPlayer2() {
        let vsRules : VerySimpleRules = VerySimpleRules(historic: [Move(owner: .player1, fromRow: 2, fromColumn: 4, toRow: 3, toColumn: 4)!])
        XCTAssertEqual(vsRules.getNextPlayer(), .player2)
    }

    func testGetNextPlayerPlayer2ToPlayer1() {
        let vsRules : VerySimpleRules = VerySimpleRules(historic: [Move(owner: .player2, fromRow: 2, fromColumn: 4, toRow: 3, toColumn: 4)!])
    ...
    func testIsMoveValidWithCoordinates(){
        ...
        self.rules = VerySimpleRules(historic: [Move(owner: .player2, fromRow: 2, fromColumn: 4, toRow: 3, toColumn: 4)!])
        XCTAssertEqual(rules?.isMoveValid(board: self.board, fromRow: 0, fromColumn: 0, toRow: 1, toColumn: 1), false)
        self.rules = VerySimpleRules(historic: [Move(owner: .player1, fromRow: 3, fromColumn: 0, toRow: 3, toColumn: 1)!])
        XCTAssertEqual(rules?.isMoveValid(board: self.board, fromRow: 0, fromColumn: 0, toRow: 1, toColumn: 1), false)
